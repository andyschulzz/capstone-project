...
export const exerciseData = [
  ...
  },
  {
    ...
    type: 'Arms',
    instructions:
      '1. Sit on a bench with a dumbbell between the legs. Place the back of the arm against the inside of the leg.\n \n2. Locking the wrist and upper arm, curl the weight while contracting the bicep as you breath out.\n \n3. Slowly lower the dumbbell back to the starting position while breathing out.',
  },
  {
    id: uuidv4(),
    name: 'Deadlift',
  ...
  },
  {
    ...
    type: 'Shoulder',
    instructions:
      '1. Secure band to object at head level and hold handles with arms extended in front.\n \n2. Keeping elbows at shoulder height, pull handles towards the side of the head while exhaling.\n \n3. Hold and return to starting position while exhaling.',
  },
  {
    id: uuidv4(),
    name: 'Front Squat',
  ...
  },
  {
    ...
    type: 'Legs',
    instructions:
      '1. Grab kettlebell and hold against chest using both hands. Stand with legs shoulder width apart.\n \n2Keeping core braced, chest up and head neutral, break at the hips keeping pressur on the midfoot and descend into a squat. Continue lowering the body until the thights are at or past parallel with the ground.\n \nxhaling, drive through the heels and midfoot, pushing knees outward until back to starting position.',
  },
  {
    id: uuidv4(),
    name: 'Hammer Curl',
  ...
  },
  {
    ...
    type: 'Core',
    instructions:
      '1. Hang from a bar with arms extended and legs straight down.\n \n2. Contract abs and raise legs until torso creates a 90 degree angle with the thighs.\n \n3. Hold position while keeping core tight, then return to the starting position.',
  },
  {
    id: uuidv4(),
    ...
    type: 'Back',
    instructions:
      '1. Grip the machine handles with both hands and sit with chest upright against the pad and back straight.\n \n3. With shoulders retracted, pull the handle towards the mid torso.\n \n4. Squeeze the back muscles as the handle approaches the torso and hold before returning to the starting position.',
  },
  {
    id: uuidv4(),
    ...
    type: 'Core',
    instructions:
      '1. Lie down on a mat with your hands on the side of your torso and feet on the floor.\n \n2. Raise your knees and your torso simultaneously until hips are flexed. Feel free to slightly bend your knees if you have flexibility issues.\n \n.3. Return to starting position.',
  },
  {
    id: uuidv4(),
    name: 'Knee Raise',
    type: 'Core',
    instructions:
      '1. Lift your legs and bring your knees to your chest. Be sure not to use any momentum and avoid swinging your legs up.abs\n \n2. Hold at the top of the movement for a brief moment, then lower your legs back down to the starting position.',
  },
  {
    id: uuidv4(),
    name: 'Lat Pulldow',
  ...
  },
  {
    ...
    type: 'Legs',
    instructions:
      '1. Starting in pushup position, with hands under shoulders and legs extended behind your.\n \n2. Bring knee of the left leg upward towards the chest.\n \n3. When leg is fully contracted under the body, extend the left leg while contracted the right leg in quick succession.',
  },
  {
    id: uuidv4(),
    name: 'Lateral Raise',
  ...
  },
  {
    ...
    type: 'Back',
    instructions:
      '1. Hold the pull up bar with a neutral grip with arms fully extended.\n \n2. Retract scapula and pull upward by bringing chest to the bar.\n \n3. Pause at the top and squeeze the back before lowering slowly to the starting position.',
  },
  {
    id: uuidv4(),
    name: 'Reverse Fly',
  ...
  },
  {
    ...
    type: 'Back',
    instructions:
      '1. Inside a power rack, set the safety bar in a low position so that the bar is slightly below your knee when at rest.\n \n2. Place your feet underneath the bar with the bar positioned over midfoot.\n \n3. Reach fo the bar by ending at the hips and hold it with a double overhand grip.\n \n4. Feel free to use lifting straps.\n \n5. Pull shoulders back at the top of the lift.\n \n6. Return to starting position by reversing the motion.',
  },
  {
    id: uuidv4(),
    name: 'Shoulder Press',
  ...
  },
  {
    ...
    type: 'Arms',
    instructions:
      '1. With a pronated grip and feet shoulder width apart, extend arms forward in front.\n \n2. Rotate wrists to reel weighted rope around the horizontal bar.\n \n3. Once weight has reached the top, reverse wrist rotation to lower weight.',
  },
]
